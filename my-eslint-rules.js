const myEslintRules = {
  ...
  rules: {
    ...
    'space-before-function-paren': [ 'warn', { anonymous: 'never', named: 'never', asyncArrow: 'always' }], // Function 과 () 사이의 띄어쓰기 여부
    ...
    'spaced-comment': [ 'warn', 'always', { block: { exceptions: [ '*' ], balanced: true } }], // 주석 표시 앞 / 뒤에 띄어쓰기 여부
