module.exports = {
  ...
  rules: {
    ...
    semi: ['warn', 'always'], // Semi-colon 표기 여부
    ...
    'semi-spacing': ['warn', { before: false, after: true }], // Semi-colon 뒤의 띄어쓰기 여부
    ...
    'function-paren-newline': ['warn', 'consistent'], // Function의 ( 뒤와 ) 앞의 줄바꿈 여부
    'function-call-argument-newline': ['warn', 'consistent'], // 함수 호출 시의 Argument 들의 줄바꿈 여부
    'no-extra-semi': 'warn', // 추가적인 Semi-colon(;)의 허용 여부
    'no-multiple-empty-lines': ['warn', { max: 1 }], // 내용 없는 라인의 허용 개수
    'no-unused-vars': 'warn', // 선언된 변수 중 사용되지 않은 변수 허용 여부
    'no-multi-spaces': ['warn'], // 두 칸 이상 띄어쓰기 허용 여부
